package com.QAframework_NavigateToDifferentPage;
...
public class NavigateToDifferentPageAndVerify {
	...
	public void navigateNewPageAndVerifyElements() {
		driver.findElement(By.xpath("//a[@title='Online Shopping']")).click();////a[@title='Online Shopping']
		WebElement redifflogo = driver.findElement(By.xpath("//img[@alt='rediff Shopping']")); //"//a[@title='Rediff Shopping']"
	    WebElement itamerow =	driver.findElement(By.xpath("//span[normalize-space()='Tata CLiQ Luxury']"));
	    
	    if(redifflogo.isDisplayed()&& redifflogo.isEnabled() && itamerow.isDisplayed() && itamerow.isEnabled() ) {
